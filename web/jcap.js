...
document.write("<span> </span><p style='position: absolute;left: 190px' ><img onclick='return jcap();'src=\"" + decodeURIComponent(imgdir) + imgid + ".jpg\" width=\"290\" height=\"130\" alt=\"\"><\/p>");

document.write("<span> </span><p><img src=\"" + decodeURIComponent(imgdir) +(imgid+1)  + ".jpg\" onclick='return jcap1();' width=\"290\" height=\"130\" alt=\"\"><\/p>");
document.write("<span> </span><p style='position: absolute;left: 830px;top: 840px'><img onclick='return jcap2();' src=\"" + decodeURIComponent(imgdir) +(imgid+2)  + ".jpg\" width=\"290\" height=\"130\" alt=\"\"><\/p>");

document.write("<br>");
document.write("<p><input type=\"text\" placeholder='Enter code then select image'  id=\"" + jfldid + "\" name=\"" + jfldid + "\" class=\"" + jfldcls + "\" size=\"" +  jfldsz + "\"><\/p>");
...
alert("Remember this image when you login select the same image");
return true;
}

else {
alert("ERROR: Enter the correct code as it is shown.");
...
var uword1 = hex_md5(document.getElementById(jfldid).value);

if (uword1==cword[anum]) {
alert("Remember this image when you login select the same image");
return true;
}
...
var uword2 = hex_md5(document.getElementById(jfldid).value);

if (uword2==cword[anum+1]) {
alert("Remember this image when you login select the same image");
return true;
}
...
var uword3 = hex_md5(document.getElementById(jfldid).value);

if (uword3==cword[anum-1]) {
alert("Remember this image when you login select the same image");
return true;
}

else {
    if (uword3==cword[anum]) {
alert("Remember this image when you login select the same image");
return true;
}
else{
